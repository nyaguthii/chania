            ...
            <div class="row">
              <div class="col-xs-6">
                    <div class="form-group">
                        <label for="quantity">Order Id</label>
                        <input class="form-control" id="id" name="id" value="{{$order->id}}" disabled>
                        <!-- /.form-group -->
                  </div>
                  <div class="form-group">
                        ...
                        <div class="input-group date">
                          ...
                          value="{{Carbon\Carbon::parse($order->transaction_date)->format('m/d/Y')}}" >
                        </div>
                        <!-- /.input group -->
                    </div>
                  <div class="form-group">
