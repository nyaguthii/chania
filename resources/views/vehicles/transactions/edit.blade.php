      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <form action="{{route('vehicleAccounts.transactions.update',['vehicleTransaction'=>$vehicleTransaction->id])}}" method="POST">
            {{ csrf_field() }}
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">              
                  ...
                  <!-- /.form-group -->
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" name="receipt_no"  placeholder="Receipt No">
                  <!-- /.form-group -->
                    </div>
                  <div class="col-md-12">
                    <div class="row">
