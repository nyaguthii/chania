...
<div class="content-wrapper">
    ...
    @include('layouts.customer-menu') 
      <div class="box box-default">
        ...
        <!-- /.box-header -->
        <form action="{{route('vehicles.store',['customer'=>$customer->id])}}" method="POST" role="form">
             {{ csrf_field() }}
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                  ...
                  <input name="registration"  class="form-control" id="registration" placeholder="Registration">
                </div>
                <div class="form-group">
                  <label for="year">Year</label>
                  <input name="year"  class="form-control" id="year" placeholder="Year">
                </div>
                <div class="form-group">
